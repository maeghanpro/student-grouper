...
import {
  Grid, Typography, Tooltip, IconButton, Button, Paper,
    ...
    <div>
      ...
      <div className="cell small-2">
        <Link to={`/classes/${arrangement.classSectionId}/students`}>
          <Button id="view-roster-button" size="large">
            View Roster
          </Button>
        </Link>
      </div>
      ...
      >
        ...
        <div className="switch-div">
          <StudentViewSwitch updateStudentView={updateStudentView} />
        </div>
      </div>
